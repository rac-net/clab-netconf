RampUp to Automation part5 - Ansible Roles and Jinja Templates

This is a repository containing all the files used to create the segment-routing network using ansible.

it includes the Containerlab script, plus the ansible playbooks for both Nokia and Cisco using netconf.
...
"git clone https://github.com/rac-net/clab-netconf.git"
